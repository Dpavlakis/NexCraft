...
Screenshots used by the docs pages and README. All are `.webp` (light mode, full-width browser).
...
| `reset-bedrock.webp` | Reset / Reinstall dialog — Bedrock (focused, version-locked) | modpacks |
