...
5. **Queued / next (start on `test`):**
   ...
   - **#14 Scheduled restarts w/ in-game warning** — FEATURE (needs brainstorm→spec→plan).
   - **#16 Sleep-on-empty / wake-on-join** — FEATURE (needs brainstorm→spec→plan).
