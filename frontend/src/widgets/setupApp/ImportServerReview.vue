...
// Persist the start command onto the config (import the uploaded server as-is).
...
// ---- Bedrock: reinstall latest + keep world (reuses the modpack reinstall flow) ----
...
<template>
  ...
  >
    <a-spin :spinning="detecting" :tip="t('TXT_CODE_import_detecting')">
      ...
      <!-- Reinstall progress (Bedrock latest install) -->
